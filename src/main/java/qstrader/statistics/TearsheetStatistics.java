 ...
 * Displays a Matplotlib-generated 'one-pager' as often
    ...
    ratio chart.
 * @author Darkness
 * @date 2017年5月9日 下午12:56:26
 * @version 1.0
 * @since 1.0
 */
public class TearsheetStatistics implements AbstractStatistics {

	private int periods = 252;
	private boolean rolling_sharpe;
	
	public TearsheetStatistics(Config config, PortfolioHandler portfolio_handler, String title, Object benchmark, int periods, boolean rolling_sharpe) {
